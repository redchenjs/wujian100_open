...
set_property -dict {PACKAGE_PIN F19 IOSTANDARD LVCMOS33 PULLUP   true} [get_ports {EXT_FLASH_NSS}]
set_property -dict {PACKAGE_PIN G19 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {EXT_FLASH_SCK}]
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {EXT_FLASH_SDI}]
set_property -dict {PACKAGE_PIN K19 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {EXT_FLASH_SDO}]

set_property -dict {PACKAGE_PIN G20 IOSTANDARD LVCMOS33 PULLUP   true} [get_ports {EXT_MCU_NRST_0}]

set_property -dict {PACKAGE_PIN M19 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {EXT_JTAG_TCK_0}]
set_property -dict {PACKAGE_PIN M20 IOSTANDARD LVCMOS33 PULLUP   true} [get_ports {EXT_JTAG_TMS_0}]
set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS33 PULLUP   true} [get_ports {EXT_UART_TXD_0}]
set_property -dict {PACKAGE_PIN M18 IOSTANDARD LVCMOS33 PULLUP   true} [get_ports {EXT_UART_RXD_0}]
