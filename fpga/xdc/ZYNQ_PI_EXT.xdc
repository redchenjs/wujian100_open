...
set_property -dict {PACKAGE_PIN F19 IOSTANDARD LVCMOS33} [get_ports {EXT_SW_0}]
set_property -dict {PACKAGE_PIN G20 IOSTANDARD LVCMOS33} [get_ports {EXT_SW_1}]
...
set_property -dict {PACKAGE_PIN W8  IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {EXT_WS2812}]

set_property -dict {PACKAGE_PIN V6  IOSTANDARD LVCMOS33 PULLUP   true} [get_ports {EXT_SPI_NSS_0}]
set_property -dict {PACKAGE_PIN T5  IOSTANDARD LVCMOS33 PULLUP   true} [get_ports {EXT_SPI_NSS_1}]
set_property -dict {PACKAGE_PIN W6  IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {EXT_SPI_SCK}]
set_property -dict {PACKAGE_PIN V8  IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {EXT_SPI_SDI}]
set_property -dict {PACKAGE_PIN U5  IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {EXT_SPI_SDO}]

set_property -dict {PACKAGE_PIN K19 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {EXT_LCD_RST}]
set_property -dict {PACKAGE_PIN L20 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {EXT_LCD_DC}]
set_property -dict {PACKAGE_PIN M19 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {EXT_LCD_CS}]
set_property -dict {PACKAGE_PIN M20 IOSTANDARD LVCMOS33 PULLDOWN true} [get_ports {EXT_LCD_BL}]
