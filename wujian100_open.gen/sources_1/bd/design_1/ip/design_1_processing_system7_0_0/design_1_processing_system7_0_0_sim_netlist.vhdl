...
-- Date        : Wed Aug 16 16:27:08 2023
-- Host        : y7000pr running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               e:/github/school/wujian100/wujian100/wujian100_open.gen/sources_1/bd/design_1/ip/design_1_processing_system7_0_0/design_1_processing_system7_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_1_processing_system7_0_0 is
  ...
  attribute POWER : string;
  attribute POWER of inst : label is "<PROCESSOR name={system} numA9Cores={2} clockFreq={50} load={0.5} /><MEMORY name={code} memType={DDR3} dataWidth={32} clockFreq={400} readRate={0.5} writeRate={0.5} /><IO interface={UART} ioStandard={LVCMOS33} bidis={2} ioBank={Vcco_p1} clockFreq={100.000000} usageRate={0.5} /><IO interface={QSPI} ioStandard={LVCMOS33} bidis={6} ioBank={Vcco_p0} clockFreq={200} usageRate={0.5} /><PLL domain={Processor} vco={2000.000} /><PLL domain={Memory} vco={1600.000} /><PLL domain={IO} vco={2000.000} />/>";
  attribute USE_TRACE_DATA_EDGE_DETECTOR : integer;
